...
{
    public partial class nhanshiphang_bkContext : DbContext
    {
        public nhanshiphang_bkContext()
        {
        }

        public nhanshiphang_bkContext(DbContextOptions<nhanshiphang_bkContext> options)
            : base(options)
        {
        }
