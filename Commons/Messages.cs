namespace KGQT.Commons
{
    public class Messages
    {
        ...
        public const string UsernameNotCorrect = "Tên tài khoản không chính xác";
        ...
        public const string DeleteError = "Lỗi xóa sản phẩm";
        public const string AddError = "Thêm không thành công";
